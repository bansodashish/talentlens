...
const FEATURES = [
  ...
  { icon: '⚡', title: 'Resume Screening',         blurb: 'Score every CV against your job description instantly with local matching. Get Strong-Hire, Consider, or Reject recommendations.' },
    ...
    <div className="min-h-screen bg-white text-slate-800">
      ...
      <section className="relative overflow-hidden bg-hero-mesh">
        <div className="max-w-6xl mx-auto px-6 py-20 lg:py-28 text-center relative z-10">
          ...
          <p className="mt-6 text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
            Source LinkedIn profiles, screen resumes quickly, and manage every candidate in one beautiful workspace - built for modern recruiters.
          </p>
      ...
      <section id="pricing" className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 mt-3">Bring your own Apify key - we only charge for the workspace.</p>
        </div>
